...
public class TC005 extends GenericWrappers {
	...
	public void bookHotelsGSTValidation() {
		...
		selectValueByName("gst", "Yes");//Select GST as Yes from the drop down
		waitProperty(1000);
		
		enterByName("gstNumber", "A9");
		enterByName("companyName", "WFHL");
		enterByName("companyAddress", "1000 State Street, Hyderabad, TS");
		waitProperty(2000);
