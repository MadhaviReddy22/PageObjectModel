	...
	public class TC004_xls extends GenericWrappers {
		
		@Test(dataProvider = "fetchData", dataProviderClass = DP004.class)
		public void bookHotelOTPValidation(String Username, String PhoneNo, String Destination, String HotelRoom, String HotelAdult, String Title,
				String FirstName, String LastName, String Country, String State, String SelectGST, String VerifyHotelName, String VerifyAmount,
			...
			selectValueByName("gst", SelectGST);//Select GST as No from the drop down
			waitProperty(3000);
			
			verifyTextByXpath("/html/body/app-root/app-fulllayout/div/app-paxdetail/main/div/div[2]/div/div/div[1]/span", VerifyHotelName); //Get the Hotel Name and Compare
			waitProperty(5000);
					                           
			verifyTextContainsByXpath("/html/body/app-root/app-fulllayout/div/app-paxdetail/main/div/div[2]/div/div/div[5]/span/b", VerifyAmount); //Get the Amount and Compare
			...
			verifyTextByXpath("//*[@id=\"OTPModal\"]/div/div/form/div[1]/span", VerifyOTPText); //Verify weather "OTP Field Is Required" text is displayed
			waitProperty(3000);
